...
public class NoteController {
  ...
  getAllNotesOfMineByCategories(Principal principal) {
    try {
      List<CategoryNotes> categoryNotes =
          categoryService
              .getAllByCreatedUser(
              ...
              .map(category
                   -> new CategoryNotes(category, noteService.getAllByCategory(
                                                      category.getId())))
  ...
  public ResponseEntity<Object>
  getNotesByCategory(@Valid @PathVariable long id) {
    try {
  ...
  @PreAuthorize("hasAnyRole('ADMIN','USER')")
  public ResponseEntity<Object>
  createNote(@Valid @RequestBody NoteCreateRequest noteCreateRequest,
             Principal principal) {
    try {
  ...
  public ResponseEntity<Object>
  updateNote(@Valid @PathVariable long id,
  ...
  public ResponseEntity<Object>
  deleteNote(@Valid @PathVariable long id, Principal principal) {
    try {
  ...
  public ResponseEntity<Object>
  deleteNotesByCategory(@Valid @PathVariable long id, Principal principal) {
    try {
